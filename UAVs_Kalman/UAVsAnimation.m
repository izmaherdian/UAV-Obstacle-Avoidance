%% UAVsAnimation - Animasi 3D Pergerakan UAV dengan Estimasi Kalman
% Script ini menampilkan visualisasi animasi 3D pergerakan robot UAV
% bersama dengan rintangan dinamis dan trajektori referensi.
...
ylabel('Y [m]');
zlabel('Z [m]');
title('UAV Kalman-Filter Scenario Obstacle Avoidance 3D Simulation');
