%% UAVsAnimation - Animasi 3D Pergerakan UAV Kasus Non-Feasible
% Script ini menampilkan visualisasi animasi 3D pergerakan robot UAV
% bersama dengan trajektori piecewise dan rintangan yang bergerak.
...
ylabel('Y [m]');
zlabel('Z [m]');
title('UAV Non-Feasible Scenario Obstacle Avoidance 3D Simulation');
